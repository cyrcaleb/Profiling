...
for t in $@; do
  ...
  echo "=== ${t} ==="
  if [ -e "/mnt/h/School/CSC-411/Assignments/Profiling/rum/target/release/build/jemalloc-sys-9c95da181d7f00fa/out/jemalloc/${t}.sh" ] ; then
    ...
    enable_fill=1 \
    enable_prof=0 \
    . /mnt/h/School/CSC-411/Assignments/Profiling/rum/target/release/build/jemalloc-sys-9c95da181d7f00fa/out/jemalloc/${t}.sh && \
    export_malloc_conf && \
    $JEMALLOC_TEST_PREFIX ${t} /mnt/h/School/CSC-411/Assignments/Profiling/rum/target/release/build/jemalloc-sys-9c95da181d7f00fa/out/jemalloc/ /mnt/h/School/CSC-411/Assignments/Profiling/rum/target/release/build/jemalloc-sys-9c95da181d7f00fa/out/build/
  else
    export MALLOC_CONF= && \
    export_malloc_conf && \
    $JEMALLOC_TEST_PREFIX ${t} /mnt/h/School/CSC-411/Assignments/Profiling/rum/target/release/build/jemalloc-sys-9c95da181d7f00fa/out/jemalloc/ /mnt/h/School/CSC-411/Assignments/Profiling/rum/target/release/build/jemalloc-sys-9c95da181d7f00fa/out/build/
