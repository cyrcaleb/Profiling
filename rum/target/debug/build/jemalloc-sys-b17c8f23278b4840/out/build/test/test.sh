...
for t in $@; do
  ...
  echo "=== ${t} ==="
  if [ -e "/mnt/h/School/CSC-411/Assignments/Profiling/rum/target/debug/build/jemalloc-sys-b17c8f23278b4840/out/jemalloc/${t}.sh" ] ; then
    ...
    enable_fill=1 \
    enable_prof=0 \
    . /mnt/h/School/CSC-411/Assignments/Profiling/rum/target/debug/build/jemalloc-sys-b17c8f23278b4840/out/jemalloc/${t}.sh && \
    export_malloc_conf && \
    $JEMALLOC_TEST_PREFIX ${t} /mnt/h/School/CSC-411/Assignments/Profiling/rum/target/debug/build/jemalloc-sys-b17c8f23278b4840/out/jemalloc/ /mnt/h/School/CSC-411/Assignments/Profiling/rum/target/debug/build/jemalloc-sys-b17c8f23278b4840/out/build/
  else
    export MALLOC_CONF= && \
    export_malloc_conf && \
    $JEMALLOC_TEST_PREFIX ${t} /mnt/h/School/CSC-411/Assignments/Profiling/rum/target/debug/build/jemalloc-sys-b17c8f23278b4840/out/jemalloc/ /mnt/h/School/CSC-411/Assignments/Profiling/rum/target/debug/build/jemalloc-sys-b17c8f23278b4840/out/build/
